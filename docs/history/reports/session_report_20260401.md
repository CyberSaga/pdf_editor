...
- `plans/acrobat_parity_improvement_plan_2026_03_31.md` — full backlog
...
**Remaining backlog (not in this session):** see `plans/acrobat_parity_improvement_plan_2026_03_31.md` for Week 2+ items.
