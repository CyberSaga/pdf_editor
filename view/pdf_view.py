...
class PDFView(QMainWindow):
    ...
    sig_edit_text = Signal(int, object, str, str, int, tuple, str, bool, object, object)  # ..., new_rect(optional), target_span_id(optional)
    ...
    def _create_text_editor(self, rect: fitz.Rect, text: str, font_name: str, font_size: float, color: tuple = (0,0,0), rotation: int = 0, target_span_id: str = None):
